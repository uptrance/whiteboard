...
.canvasContainer {
  @apply relative h-screen w-screen bg-gray-50;
}
.tool {
  @apply relative top-1/2 left-4 h-80 w-12 -translate-y-1/2 rounded-full bg-gray-200 shadow-md;
  ul {
    @apply absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2;
    li {
      @apply mb-2 h-10 w-10 rounded-full bg-white fill-gray-600 p-2;
      @apply hover:bg-blue-400 hover:fill-gray-100;
    }
  }
}
.backIcon {
  @apply absolute top-4 left-4 h-10 w-10 rounded-lg p-3 shadow-md;
  @apply hover:bg-blue-400 hover:fill-gray-100;
  svg {
    /* @apply h-6 w-6; */
  }
